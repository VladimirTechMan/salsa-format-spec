...
* "base64": The "body" value in the "packet" object MUST be a string that represents all the bytes from the original packet body encoded using base64, as described in RFC 4648. This format option is suitable for any textual or binary-format protocol packets.
